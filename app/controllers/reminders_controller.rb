class RemindersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @reminder.save
        format.html { redirect_to :root, notice: "Reminder was successfully created." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to :root, notice: "Reminder was successfully destroyed." }
  ...
  private
    ...
    def reminder_params
      params.require(:reminder).permit(:reminder_text)
    end
end
