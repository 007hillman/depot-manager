...
class DrawingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drawing" do
    assert_difference("Drawing.count") do
      post drawings_url, params: { drawing: { drink_id: @drawing.drink_id, quantity: @drawing.quantity } }
    end
  ...
  test "should update drawing" do
    patch drawing_url(@drawing), params: { drawing: { drink_id: @drawing.drink_id, quantity: @drawing.quantity } }
