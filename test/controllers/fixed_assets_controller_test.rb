...
class FixedAssetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fixed_asset" do
    assert_difference("FixedAsset.count") do
      post fixed_assets_url, params: { fixed_asset: { asset_name: @fixed_asset.asset_name, asset_unit_price: @fixed_asset.asset_unit_price } }
    end
  ...
  test "should update fixed_asset" do
    patch fixed_asset_url(@fixed_asset), params: { fixed_asset: { asset_name: @fixed_asset.asset_name, asset_unit_price: @fixed_asset.asset_unit_price } }
